...
/* The examples use simple WiFi configuration that you can set via
   ...
   configuration of AP.
*/
#define EXAMPLE_WIFI_SSID "UniMAP-WiFi"
#define EXAMPLE_EAP_METHOD EAP_TYPE_PEAP 

#define EXAMPLE_EAP_ID "241021381"
//#define EXAMPLE_EAP_ID CONFIG_EXAMPLE_EAP_ID 
//#define EXAMPLE_EAP_USERNAME CONFIG_EXAMPLE_EAP_USERNAME 
//#define EXAMPLE_EAP_USERNAME "241021381" 
#define EXAMPLE_EAP_PASSWORD "241021381" 
...
static void initialise_wifi(void)
{
    ...
    ESP_ERROR_CHECK(esp_eap_client_set_identity((uint8_t *)EXAMPLE_EAP_ID, strlen(EXAMPLE_EAP_ID)) );
    ESP_ERROR_CHECK(esp_eap_client_set_new_password((uint8_t *)EXAMPLE_EAP_PASSWORD, strlen(EXAMPLE_EAP_PASSWORD)) );
    ESP_ERROR_CHECK(esp_eap_client_set_ttls_phase2_method(EAP_TTLS_PHASE2_MSCHAPV2));
